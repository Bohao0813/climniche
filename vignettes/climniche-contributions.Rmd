...
niche potential, the squared sensitivity weighted distance from the realised
niche centre, among the fitted climate variables at each cell.
...
Panel (a) maps the variable with the largest absolute contribution. Panel (b)
maps its share of the total absolute contribution at the same cell. Mean pH
has the largest absolute term across most of the weighted anchovy reference
habitat. Temperature range and salinity range have the largest term in smaller,
...
These contributions decompose future minus current niche potential. They do
not estimate SDM variable importance or causal climatic effects. When the
fitted metric matrix is non-diagonal, each variable contribution also contains
its allocated cross-variable terms in the fitted climatic basis.
