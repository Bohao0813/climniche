...
Mediterranean Sea. Prepared tables and figures come from Bio-ORACLE v3 surface
layers, OBIS occurrence records, and a continuous presence-background SDM
suitability map. The SDM threshold is selected by maximum test-set TSS. The
`climniche` step uses the remaining suitability values as continuous reference
weights.
...
The fit returns four quantities. Climatic Displacement is the
