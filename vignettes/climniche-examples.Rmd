...
presence-background SDM suitability map. The SDM threshold is selected by
maximum test-set TSS. The `climniche` step uses the remaining suitability
values as continuous reference weights.
...
distance from current to future conditions in the fitted sensitivity weighted
