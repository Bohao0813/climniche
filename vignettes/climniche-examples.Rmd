...
continuous presence-background SDM. `climniche` treats above-threshold
suitability values as reference weights.
...
Variable contributions summarize fitted change; they should not be interpreted
causally.
